...
public class RoomServiceImpl implements RoomService {
	...
	public Room findByRoomNumber(String roomNumber) {
		negativeRoomNumberCheck(roomNumber);
	...
	private void negativeRoomNumberCheck(String roomNumber) {
		int roomNumberAsInteger = Integer.parseInt(roomNumber);

		if(roomNumberAsInteger < 0) {
			throw new RoomServiceClientException("The room number cannot be negative");
		}
	}
